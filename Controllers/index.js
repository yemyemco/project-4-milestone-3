...
const {enrollstudent} = async function(req, res)
{
    try {
...
const {viewenrolledstudents} = async function (req, res)
{
    try {
...
const {courseregistration} = async function(req, res)
{
...
const {viewstudentsbycourse} = async function(req, res)
{
    try {
...
const {viewcourseenrollment} = async function(req, res)
{
